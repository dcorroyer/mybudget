...
final class GetExpenseCategoryControllerTest extends WebTestCase
{
    use Factories;
    ...
    public function getExpenseCategoryController_WhenDataOk_ReturnsExpenseCategory(): void
    {
        ...
        $this->assertEquals($expenseCategory->getId(), $data['id']);
        $this->assertEquals($expenseCategory->getName(), $data['name']);
    }
}
