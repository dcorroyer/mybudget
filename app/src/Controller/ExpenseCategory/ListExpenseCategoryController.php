...
class ListExpenseCategoryController extends BaseRestController
{
    ...
    #[Route('', name: 'api_expenses_categories_list', methods: Request::METHOD_GET)]
    public function __invoke(
        ...
        return $this->paginateResponse($expenseCategoryService->paginate($paginationQueryParams), [SerializationGroups::EXPENSE_CATEGORY_LIST]);
    }
}
