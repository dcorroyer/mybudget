 ...
 */
final class Version20240322163000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expenses (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, budget_id INT DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_2496F35B12469DE2 (category_id), INDEX IDX_2496F35B36ABA6B8 (budget_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE incomes (id INT AUTO_INCREMENT NOT NULL, budget_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, amount DOUBLE PRECISION NOT NULL, INDEX IDX_9DE2B5BD36ABA6B8 (budget_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
