...
class CreateExpenseController extends BaseRestController
{
    ...
    public function __invoke(ExpenseService $expenseService, #[MapRequestPayload] ExpensePayload $expensePayload): JsonResponse
    {
        $expenseResponse = $expenseService->create($expensePayload);

        return $this->successResponse(data: $expenseResponse, groups: [SerializationGroups::EXPENSE_CREATE], status: Response::HTTP_CREATED);
    }
}
