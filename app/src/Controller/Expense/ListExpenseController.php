...
class ListExpenseController extends BaseRestController
{
    ...
    #[Route('', name: 'api_expenses_list', methods: Request::METHOD_GET)]
    public function __invoke(
        ExpenseService $expenseService,
        #[MapQueryString] ?PaginationQueryParams $paginationQueryParams = null,
        #[MapQueryString] ?ExpenseFilterQuery $filter = null,
    ): JsonResponse {
        return $this->paginateResponse($expenseService->paginate($paginationQueryParams, $filter), [SerializationGroups::EXPENSE_LIST]);
    }
}
