...
final class Version0_0_0 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expenses (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', budget_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, amount DOUBLE PRECISION NOT NULL, category VARCHAR(255) NOT NULL, INDEX IDX_2496F35B36ABA6B8 (budget_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
