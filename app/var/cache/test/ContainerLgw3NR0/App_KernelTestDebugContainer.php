...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Authentication\\RegisterController' => 'getRegisterControllerService',
            'App\\Controller\\ExpenseCategory\\GetExpenseCategoryController' => 'getGetExpenseCategoryControllerService',
            'App\\Controller\\ExpenseCategory\\ListExpenseCategoryController' => 'getListExpenseCategoryControllerService',
            'App\\Controller\\ExpenseCategory\\UpdateExpenseCategoryController' => 'getUpdateExpenseCategoryControllerService',
            'App\\Controller\\Expense\\CreateExpenseController' => 'getCreateExpenseControllerService',
            'App\\Controller\\Expense\\DeleteExpenseController' => 'getDeleteExpenseControllerService',
            'App\\Controller\\Expense\\GetExpenseController' => 'getGetExpenseControllerService',
            'App\\Controller\\Expense\\ListExpenseController' => 'getListExpenseControllerService',
            'App\\Controller\\Expense\\UpdateExpenseController' => 'getUpdateExpenseControllerService',
            'App\\Controller\\Income\\CreateIncomeController' => 'getCreateIncomeControllerService',
            'App\\Controller\\Income\\DeleteIncomeController' => 'getDeleteIncomeControllerService',
            'App\\Controller\\Income\\GetIncomeController' => 'getGetIncomeControllerService',
            'App\\Controller\\Income\\ListIncomeController' => 'getListIncomeControllerService',
            'App\\Controller\\Income\\UpdateIncomeController' => 'getUpdateIncomeControllerService',
            'App\\Controller\\Tracking\\CreateTrackingController' => 'getCreateTrackingControllerService',
            'App\\Controller\\Tracking\\DeleteTrackingController' => 'getDeleteTrackingControllerService',
            'App\\Controller\\Tracking\\GetTrackingController' => 'getGetTrackingControllerService',
            'App\\Controller\\Tracking\\ListTrackingController' => 'getListTrackingControllerService',
            'App\\Controller\\Tracking\\UpdateTrackingController' => 'getUpdateTrackingControllerService',
            'App\\Controller\\User\\GetUserController' => 'getGetUserControllerService',
            'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController' => 'getProfilerControllerService',
            'My\\RestBundle\\Controller\\BaseRestController' => 'getBaseRestControllerService',
    ...
    {
        return $container->services['cache.pentatrion_vite_fallback'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(($container->privates['cache.pentatrion_vite_fallback.recorder_inner'] ?? self::getCache_PentatrionViteFallback_RecorderInnerService($container)));
    }
    ...
    /**
     * Gets the private '.service_locator.BXBovcL' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_BXBovcLService($container)
    {
        return $container->privates['.service_locator.BXBovcL'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    /**
     * Gets the private 'cache.pentatrion_vite_fallback.recorder_inner' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\AdapterInterface
     */
    protected static function getCache_PentatrionViteFallback_RecorderInnerService($container)
    {
        return $container->privates['cache.pentatrion_vite_fallback.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FsOUV9qYwX', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDataCollector_EventsService($container)
    {
        return $container->privates['data_collector.events'] = new \Symfony\Component\HttpKernel\DataCollector\EventDataCollector(new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.event_dispatcher.register' => ($container->privates['debug.security.event_dispatcher.register'] ?? $container->load('getDebug_Security_EventDispatcher_RegisterService'));
        ...
        }, 5), ($container->services['.virtual_request_stack'] ?? self::get_VirtualRequestStackService($container)));
    }
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\Authentication\\RegisterController', 'App\\Controller\\Expense\\CreateExpenseController', 'App\\Controller\\Expense\\DeleteExpenseController', 'App\\Controller\\Expense\\GetExpenseController', 'App\\Controller\\Expense\\ListExpenseController', 'App\\Controller\\Expense\\UpdateExpenseController', 'App\\Controller\\ExpenseCategory\\GetExpenseCategoryController', 'App\\Controller\\ExpenseCategory\\ListExpenseCategoryController', 'App\\Controller\\ExpenseCategory\\UpdateExpenseCategoryController', 'App\\Controller\\Income\\CreateIncomeController', 'App\\Controller\\Income\\DeleteIncomeController', 'App\\Controller\\Income\\GetIncomeController', 'App\\Controller\\Income\\ListIncomeController', 'App\\Controller\\Income\\UpdateIncomeController', 'App\\Controller\\Tracking\\CreateTrackingController', 'App\\Controller\\Tracking\\DeleteTrackingController', 'App\\Controller\\Tracking\\GetTrackingController', 'App\\Controller\\Tracking\\ListTrackingController', 'App\\Controller\\Tracking\\UpdateTrackingController', 'App\\Controller\\User\\GetUserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController', 'My\\RestBundle\\Controller\\BaseRestController', 'Pentatrion\\ViteBundle\\Controller\\ViteController']);
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)
    {
        ...
        $a = new \Doctrine\Bundle\DoctrineBundle\Middleware\DebugMiddleware(($container->privates['doctrine.debug_data_holder'] ??= new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder([])), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    ...
    /**
     * Gets the private 'pentatrion_vite.tag_renderer_collection' shared service.
     *
     * @return \Pentatrion\ViteBundle\Service\TagRendererCollection
     */
    protected static function getPentatrionVite_TagRendererCollectionService($container)
    {
        return $container->privates['pentatrion_vite.tag_renderer_collection'] = new \Pentatrion\ViteBundle\Service\TagRendererCollection(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    /**
     * Gets the private 'pentatrion_vite.twig_entry_files_extension' shared service.
     *
     * @return \Pentatrion\ViteBundle\Twig\EntryFilesTwigExtension
     */
    protected static function getPentatrionVite_TwigEntryFilesExtensionService($container)
    {
        $a = ($container->privates['pentatrion_vite.entrypoint_renderer'] ?? self::getPentatrionVite_EntrypointRendererService($container));

        if (isset($container->privates['pentatrion_vite.twig_entry_files_extension'])) {
            return $container->privates['pentatrion_vite.twig_entry_files_extension'];
        }

        return $container->privates['pentatrion_vite.twig_entry_files_extension'] = new \Pentatrion\ViteBundle\Twig\EntryFilesTwigExtension($a);
    }
    ...
    {
        $a = ($container->privates['.service_locator.BXBovcL'] ?? self::get_ServiceLocator_BXBovcLService($container));
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.register' => ($container->privates['.security.request_matcher.iRmxrxk'] ?? $container->load('get_Security_RequestMatcher_IRmxrxkService'));
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(($container->privates['pentatrion_vite.twig_entry_files_extension'] ?? self::getPentatrionVite_TwigEntryFilesExtensionService($container)));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'MyRestBundle' => 'My\\RestBundle\\MyRestBundle',
            ...
            'kernel.bundles_metadata' => [
                ...
                'MyRestBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/dcorroyer/my-rest-bundle/src'),
            ...
            'pentatrion_vite.crossorigin' => false,
