...
final class Version1_0_4 extends AbstractMigration
{
    ...
    {
        return 'create trackings table and drop data field in expenses and incomes';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE trackings (id INT AUTO_INCREMENT NOT NULL, income_id INT NOT NULL, expense_id INT NOT NULL, name VARCHAR(255) NOT NULL, saving_capacity DOUBLE PRECISION NOT NULL, date DATE NOT NULL, created_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', updated_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', UNIQUE INDEX UNIQ_A87C621C640ED2C0 (income_id), UNIQUE INDEX UNIQ_A87C621CF395DB7B (expense_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE trackings ADD CONSTRAINT FK_A87C621C640ED2C0 FOREIGN KEY (income_id) REFERENCES incomes (id)');
        $this->addSql('ALTER TABLE trackings ADD CONSTRAINT FK_A87C621CF395DB7B FOREIGN KEY (expense_id) REFERENCES expenses (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trackings DROP FOREIGN KEY FK_A87C621C640ED2C0');
        $this->addSql('ALTER TABLE trackings DROP FOREIGN KEY FK_A87C621CF395DB7B');
